...
export default async function CreatorPage({ params }: { params: Promise<{ handle: string }> }) {
  ...
  return (
    <main className="detail-shell" id="main" tabIndex={-1}>
      ...
      <section className="detail-hero"><div><span className="eyebrow">Public creator current</span><h1>{creator.handle}</h1><p>Identity links are shown only when verified by explicit public repository metadata.</p></div></section>
